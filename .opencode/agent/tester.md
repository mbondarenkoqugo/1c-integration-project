...
description: Expert 1C testing agent. Tests code and functions using web browser automation
  and the deploy_and_test command. Deploys configuration to test infobase, performs
  UI testing with human-like interactions, validates functionality. Use when the user
  asks to run deployment, UI testing, or verification against a test infobase.
model: opus
permission:
  read: allow
  edit: allow
