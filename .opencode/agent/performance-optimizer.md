...
description: Expert 1C performance optimization specialist. Analyzes code for performance
  issues, optimizes queries, identifies bottlenecks, and provides concrete improvements.
  Use PROACTIVELY when performance issues are suspected or after code review identifies
  slow code.
model: opus
permission:
  read: allow
